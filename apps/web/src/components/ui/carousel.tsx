...
export function Carousel({ children }: Props) {
  ...
  return (
    ...
    >
      {children}
      <button
        className="absolute right-5 top-1/2 hidden -translate-y-1/2 rounded-[5rem] border border-neutral-400 bg-neutral-200/50 px-2 py-4 backdrop-blur-sm duration-300 focus:outline-none focus-visible:ring-2 active:scale-75 sm:block dark:border-neutral-600 dark:bg-neutral-700/50"
        id="slideRight"
      >
        <ChevronRight className="h-4 w-4 stroke-[3]" />
      </button>
      <button
        className="absolute left-5 top-1/2 hidden -translate-y-1/2 rounded-[5rem] border border-neutral-400 bg-neutral-200/50 px-2 py-4 backdrop-blur-sm duration-300 focus:outline-none focus-visible:ring-2 active:scale-75 sm:block dark:border-neutral-600 dark:bg-neutral-700/50"
        id="slideLeft"
      >
