  ...
  return (
    <div className="flex h-full flex-1 flex-col">
      ...
      <div className="flex flex-1 flex-wrap gap-2 md:flex-nowrap">
        <div className="flex w-full flex-col gap-2 overflow-hidden rounded-l-2xl rounded-r-2xl border border-zinc-300 md:w-[500px] md:rounded-r-xl dark:border-zinc-700">
          <FormField
