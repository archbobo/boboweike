...
function Track({ className, difficulty, id, label }: Track) {
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'flex w-full cursor-pointer items-center justify-between gap-3 overflow-hidden rounded-lg bg-neutral-500/10 p-4 py-2 text-black/90 duration-300 group-active/challenge:bg-neutral-500/40 group-active/challenge:duration-75 sm:py-4 dark:text-white/90',
          className,
          !isMobile &&
