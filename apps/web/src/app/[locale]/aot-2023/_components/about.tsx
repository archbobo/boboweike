    ...
    <Sheet>
      ...
      >
        ...
        <div className="flex flex-col gap-5 text-lg tracking-tight">
          <p>
            The 波波微课 team wants to thank you for taking part in our first Advent of TypeScript.
            ...
            questions, feel free to reach out to us on GitHub.
          </p>
          ...
          <p>
            <span className="font-bold text-red-600">3.</span> Remember, it’s all about having fun!
