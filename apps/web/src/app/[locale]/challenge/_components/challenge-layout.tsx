  ...
  return (
    ...
    >
      ...
      <div
        ...
        ref={resizer}
      >
        <div className="absolute left-1/2 top-1/2 h-1 w-24 -translate-x-1/2 -translate-y-1/2 rounded-full bg-neutral-400 duration-300 group-hover:bg-neutral-600 group-active:duration-75 lg:h-24 lg:w-1 dark:bg-neutral-700 group-hover:dark:bg-neutral-500" />
      </div>
      <div
