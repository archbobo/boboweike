...
export function ChallengeLayout({ left, right }: ChallengeLayoutProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex min-h-[90px] w-full flex-1 flex-grow flex-col overflow-hidden rounded-l-xl rounded-r-2xl border border-zinc-300 lg:min-w-[500px] dark:border-zinc-700"
        ref={rightSide}
      >
        {right}
      </div>
