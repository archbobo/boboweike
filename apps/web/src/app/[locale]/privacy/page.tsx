...
export default function Page() {
  return (
    <div className="prose dark:prose-invert container justify-center py-10">
      ...
      <p>
        At 波波微课, accessible from https://boboweike.cn, one of our main priorities is the privacy
        of our visitors. This Privacy Policy document contains types of information that is
        collected and recorded by 波波微课 and how we use it.
      </p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in 波波微课. This
      ...
      <p>
        波波微课 follows a standard procedure of using log files. These files log visitors when they
      ...
      <p>
        Like any other website, 波波微课 uses "cookies". These cookies are used to store information
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on 波波微课,
      ...
      <p>
        Note that 波波微课 has no access to or control over these cookies that are used by
      ...
      <p>
        波波微课 does not knowingly collect any Personal Identifiable Information from children
