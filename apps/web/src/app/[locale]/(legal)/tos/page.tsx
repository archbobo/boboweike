  ...
  return (
    <>
      <div className="prose dark:prose-invert container justify-center py-10">
        ...
        <p>
          All the materials on 波波微课's Website are provided "as is". 波波微课 makes no
          warranties, may it be expressed or implied, therefore negates all other warranties.
          Furthermore, 波波微课 does not make any representations concerning the accuracy or
        ...
        <p>
          波波微课 or its suppliers will not be hold accountable for any damages that will arise
          with the use or inability to use the materials on 波波微课's Website, even if 波波微课 or
        ...
        <p>
          ...
          photographic errors. 波波微课 will not promise that any of the materials in this Website
          are accurate, complete, or current. 波波微课 may change the materials contained on its
          Website at any time without notice. 波波微课 does not make any commitment to update the
          materials.
        </p>
        ...
        <p>
          波波微课 has not reviewed all of the sites linked to its Website and is not responsible
          for the contents of any such linked site. The presence of any link does not imply
          endorsement by 波波微课 of the site. The use of any linked website is at the user's own
          risk.
        </p>
        ...
        <p>
          波波微课 may revise these Terms of Use for its Website at any time without prior notice.
        ...
        <p>
          Any claim related to 波波微课's Website shall be governed by the laws of af without
