      ...
      <div className="container relative grid min-h-screen items-center justify-center py-24 lg:min-h-0 lg:grid-cols-2 lg:py-0">
        ...
        <div className="flex w-full flex-col items-center justify-center gap-10 lg:items-start">
          ...
          <div className="relative flex w-full items-center justify-center gap-4 lg:justify-start">
            ...
            <TypeHeroLogo3D />
            <h1 className="animate-bg-gradient-to-center-title dark:to-69% bg-gradient-to-br from-[#3178c6] from-[69%] to-black/0 bg-clip-text bg-right-bottom text-6xl font-extrabold text-transparent sm:text-8xl sm:leading-[5.5rem] dark:from-white dark:from-30% dark:via-[#3178c6] dark:to-[#3178c6] dark:bg-[length:300%_300%]">
              波波
              <br />
              微课
            </h1>
          ...
          <div className="flex flex-col-reverse gap-3 md:flex-row">
            ...
            {session ? (
              <Button
                asChild
                className="hero-join-button group relative mx-auto w-fit overflow-hidden rounded-xl p-[2px] font-bold transition-all duration-300 hover:bg-transparent hover:shadow-[0_0_2rem_-0.5rem_#FFB800] md:mr-0 lg:mr-auto dark:hidden"
                variant="outline"
              >
                <Link href="/explore">
