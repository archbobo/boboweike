        ...
        <div className="flex w-full flex-col items-center justify-center gap-10 lg:items-start">
          ...
          <div className="flex flex-col-reverse gap-3 md:flex-row">
            ...
            {session ? (
              <Button
                asChild
                className="hero-join-button group relative mx-auto w-fit overflow-hidden rounded-xl p-[2px] font-bold transition-all duration-300 hover:bg-transparent hover:shadow-[0_0_2rem_-0.5rem_#3B82F6] md:mr-0 lg:mr-auto dark:hidden"
                variant="outline"
              >
                <Link href="/explore">
