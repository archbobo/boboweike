...
export function ActionButton({ action, text, trackId }: EnrollButtonProps) {
  ...
  return (
    ...
    >
      {isLoading ? (
        <Loader2 className="mx-[1.125rem] h-5 w-5 animate-spin" />
      ) : text == 'Enroll' ? (
        <>
          <svg
