    ...
    <>
      <div className="prose dark:prose-invert container justify-center py-10">
        ...
        <p>
          ...
          <a href="mailto:support@boboweike.cn">support@boboweike.cn</a>.
        </p>
        ...
        <p>
          波波微课 follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          Like any other website, 波波微课 uses "cookies". These cookies are used to store
        ...
        <p>
          ...
          波波微课, which are sent directly to users' browser. They automatically receive your IP
