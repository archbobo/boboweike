...
export async function GET(request: Request) {
  ...
  const title = hasTitle
    ...
    : 'A fun typescript challenge site';
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* TODO: move this to an import when it works  */}
        <svg
          style={{ marginTop: 60 }}
          height="128"
          width="128"
        ...
        <p style={{ marginTop: 20, fontSize: 120 }}>波波微课</p>
        <p style={{ marginTop: 60, fontSize: 70 }}>{title}</p>
      </div>
    ),
    {
      width: 1200,
