...
export const VercelInviteUserEmail = ({}: VercelInviteUserEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Thanks for joining the 波波微课 waitlist</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-[40px] w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            <Section className="mt-[32px]">
              <Img
                src={`${baseUrl}/static/boboweike.png`}
                width="40"
                height="37"
                alt="Vercel"
            ...
            <Img src={`${baseUrl}/static/signup.gif`} alt="Vercel" className="mx-auto my-0" />
            <Text className="text-[14px] leading-[24px] text-black">
