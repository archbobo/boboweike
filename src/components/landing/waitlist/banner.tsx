      ...
      <div className="container relative grid grid-cols-1 items-center justify-center md:grid-cols-2">
        <div className="flex flex-col gap-8 pb-16 pt-56 md:py-16">
          ...
          <p className="leading-loose text-zinc-600 dark:text-zinc-400">
            <Balancer>
              We’re currently working hard to make 波波微课 the perfect place for Golang enthusiasts
              and learners. If you believe 波波微课 can help you become a better Golang developer in
              the future, consider joining our waitlist.
            </Balancer>
          </p>
          ...
          >
            <Link href="/waitlist">
              <span className="inline-flex h-full w-fit items-center gap-1 rounded-[10px] bg-neutral-100 px-4 py-2 font-bold text-black transition-colors duration-200 group-hover:bg-white dark:bg-neutral-900 dark:text-white group-hover:dark:bg-black">
