  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3">
        <div
          className={`inline-flex w-fit translate-x-1 items-center rounded-full border border-transparent px-2.5 py-0.5 text-xs font-semibold text-primary-foreground duration-300 group-hover/card:-translate-x-1 group-hover/card:-translate-y-1 group-hover/card:shadow-[0.75rem_0.75rem_1rem_-0.25rem_#0008] ${COLORS_BY_DIFFICULTY[difficulty || 'HARD']}`}
        >
          {difficulty || 'HARD'}
        </div>
        <div className="flex w-fit items-center justify-center rounded-full bg-neutral-300 bg-transparent px-2.5 py-1 pl-1.5 pr-2 text-xs font-bold text-neutral-700 duration-300 group-hover/card:-translate-x-2 group-hover/card:-translate-y-1 group-hover/card:shadow-[0.75rem_0.75rem_1rem_-0.25rem_#0008] dark:bg-zinc-700 dark:text-white">
          @you
        </div>
      </div>
      ...
      <div className="mt-4 h-56 flex-grow rounded-xl bg-zinc-300/70 p-4 duration-300 group-hover/card:-translate-x-3 group-hover/card:-translate-y-3 group-hover/card:shadow-[1rem_1rem_2.5rem_-1rem_#0008] dark:bg-zinc-800/70">
        <svg
          width="256"
          height="193"
          viewBox="0 0 256 193"
