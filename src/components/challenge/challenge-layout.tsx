...
export function ChallengeLayout({ left, right }: ChallengeLayoutProps) {
  ...
  return (
    ...
    >
      <div
        ref={leftSide}
        className="min-h-[318px] w-full overflow-hidden rounded-l-2xl rounded-r-xl border border-zinc-300 bg-white dark:border-zinc-700 dark:bg-zinc-800 lg:w-1/4 lg:min-w-[500px]"
      >
        {left}
      </div>
