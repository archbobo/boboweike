...
Thank you for considering contributing to 波波微课. As an open sourced project
...
- Open an [Issue](https://github.com/boboweike/boboweike/issues/new/choose).
...
- Perform a search in [GitHub](https://github.com/boboweike/boboweike/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc). If it has,
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/boboweike/boboweike/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc).
...
1. Choose an issue from the [GitHub issues](https://github.com/boboweike/boboweike/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc), ask a member of the team
...
4. We do not enforce a commit style like
   ...
   or the body of the commit message. See [Commits](https://github.com/boboweike/boboweike/commits/main) for example
   commits.
