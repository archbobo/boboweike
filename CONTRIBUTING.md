...
- Open an [Issue](https://github.com/archbobo/boboweike/issues/new/choose).
...
- Perform a search in [GitHub](https://github.com/archbobo/boboweike/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc), or the
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/archbobo/boboweike/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc).
...
1. Choose an issue from the [GitHub issues](https://github.com/archbobo/boboweike/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc), ask a member of the team
...
4. We do not enforce a commit style like
   ...
   or the body of the commit message. See [Commits](https://github.com/archbobo/boboweike/commits/main) for example
   commits.
